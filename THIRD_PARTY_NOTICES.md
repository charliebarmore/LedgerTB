...
ProBooks is distributed under the MIT License. It also uses third-party
software under its own licenses.

## pypdfium2 and PDFium

ProBooks uses `pypdfium2` for local PDF text extraction and page rendering.
...
Packaged ProBooks builds include the complete license material supplied by the
