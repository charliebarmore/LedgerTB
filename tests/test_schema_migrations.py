...
def test_create_tables_builds_full_schema(db):
    ...
    expected = {
        ...
        "import_batch_reversals", "journal_entry_templates",
        "journal_entry_template_lines", "recurring_schedules",
...
def test_create_tables_records_migrations(db):
    ...
    assert [row[0] for row in cur.fetchall()] == [
        ...
        "024_recurring_journal_entries", "025_recurring_draft_snapshots",
        "026_import_review_drafts", "027_review_recovery"]
    conn.close()
